package com.samboluong.arcmenu;
...
public class ArcMenu extends ViewGroup implements View.OnClickListener
{
    ...
    public void setOnMenuItemClickListener(OnMenuItemClickListener mMenuItemListener)
    {
    ...
    public ArcMenu(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes)
    {
        ...
        // 获取自定义属性的值
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, R.styleable.ArcMenu, defStyleAttr, defStyleRes);
    ...
    public void toggleMenu(int duration)
    {
        ...
        for (int i = 0; i < count - 1; i++)
        {
            ...
            // 旋转动画
            RotateAnimation rotateAnim = new RotateAnimation(0, 720, RotateAnimation.RELATIVE_TO_SELF, 0.5f, RotateAnimation.RELATIVE_TO_SELF, 0.5f);
            ...
            child.setOnClickListener(new OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    ...
                    {
                        mMenuItemListener.onClick(child, pos);
                    }

                    menuItemClickAnim(pos - 1);
